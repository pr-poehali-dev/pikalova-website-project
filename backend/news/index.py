'''
Business: API для управления новостями театра (получение, создание)
    ...
    try:
        if method == 'GET':
            ...
            return {
                ...
                'body': json.dumps([dict(item) for item in news], default=str),
                'isBase64Encoded': False
            }
            ...
            cur.execute(
                "INSERT INTO news (title, description, content, image_url) VALUES (%s, %s, %s, %s) RETURNING *",
